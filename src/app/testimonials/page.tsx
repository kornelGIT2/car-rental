...
function Testimonials() {
  return (
    <section className="flex bg-zinc-50 justify-center items-center section p-4 min-h-[700px] overflow-hidden flex-col gap-10">
      <h1 className="font-bold xl:text-4xl text-2xl">Our reviews</h1>
      <ul className="flex md:flex-row flex-col gap-10 mb-10">
